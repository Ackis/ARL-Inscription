...
function module:InitializeRecipes()
	local function AddRecipe(spellID, expansionID, quality)
		return addon:AddRecipe(module, {
			...
			_localizedProfessionName = _G.GetSpellInfo(constants.PROFESSION_SPELL_IDS.INSCRIPTION),
	...
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30710, 30711, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 49885, 53415, 56065, 62327, 64691, 66355, 79519, 81770, 85911, 86015)
	...
	recipe:SetItemFilterType("INSCRIPTION_SCROLL")
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30710, 30711, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 47384, 47396, 47400, 47418, 47419, 47420, 47421, 47431, 48619, 49885, 53415, 56065, 57620, 62327, 64691, 65043, 66355, 79519, 81770, 85911, 86015)
	...
	recipe:SetItemFilterType("INSCRIPTION_SCROLL")
	recipe:AddFilters(F.CASTER, F.HEALER)
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30710, 30711, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 53415, 56065, 62327, 64691, 66355, 79519, 81770, 85911, 86015)
	...
	-- Glyph of Hemorrhaging Veins -- 57129
	...
	recipe:SetItemFilterType("INSCRIPTION_MAJOR_GLYPH")
	recipe:AddFilters(F.DPS, F.TANK, F.WARRIOR)
	recipe:AddDiscovery("DISCOVERY_INSC_SHIMMERING")
	...
	recipe:SetItemFilterType("INSCRIPTION_MAJOR_GLYPH")
	recipe:AddFilters(F.CASTER, F.DPS, F.DRUID)
	recipe:AddDiscovery("DISCOVERY_INSC_BLACKFALLOW")
	...
	recipe:SetItemFilterType("INSCRIPTION_SCROLL")
	recipe:AddTrainer(26916, 26977, 26995, 28702, 30706, 30709, 30710, 30711, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 53415, 56065, 62327, 64691, 66355, 79519, 81770, 85911, 86015)
	...
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(26916, 26995, 28702, 30706, 30709, 30710, 30711, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 53415, 56065, 62327, 64691, 66355, 79519, 81770, 85911, 86015)
	...
	recipe:SetItemFilterType("INSCRIPTION_CREATED_ITEM")
	recipe:AddTrainer(26916, 26995, 28702, 30709, 30713, 30715, 30716, 30717, 30721, 33603, 33615, 33638, 33679, 53415, 56065, 64691, 66355, 79519, 81770, 85911)
	...
	recipe:SetItemFilterType("INSCRIPTION_MATERIALS")
	recipe:AddTrainer(26916, 26977, 26995, 28702, 30706, 30709, 30710, 30711, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 49885, 53415, 56065, 62327, 64691, 66355, 79519, 81770, 85911, 86015)
	...
	recipe:SetItemFilterType("INSCRIPTION_MAJOR_GLYPH")
	recipe:AddFilters(F.TANK, F.MONK)
	recipe:AddDiscovery("DISCOVERY_INSC_SEA")
	...
	recipe:SetItemFilterType("INSCRIPTION_MAJOR_GLYPH")
	recipe:AddFilters(F.DPS, F.TANK, F.SHAMAN)
	recipe:AddDiscovery("DISCOVERY_INSC_WARBINDER")
	...
	-- Glyph of the Flapping Owl -- 175186
